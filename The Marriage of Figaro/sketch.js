...
Officer: 5979363
CaseNum: 801-3-97564145-5979363

We have a chance to record the powerful Order of Tukey before the curtain comes 
down on the Marriage of Figaro. They might be the most influential group in 
console city but they still have their quirks and will be spotable thanks 
their trademark moustache.
...
function draw()
{
	...
	{
		for (let j = 0; j < patrons[i].length; j++)
		{
			if (wanted[index] == true)
			{
